                    ...
                    <div class="form-row" style="margin-bottom: 15px;">
                        ...
                        <div class="col">
                            <div>
                                ...
                                <option value="indian"  @if(isset($inputs) && isset($inputs['nationality']) && $inputs['nationality'] == 'female') selected @endif>Indian</option>
                                <option value="others"   @if(isset($inputs) && isset($inputs['nationality']) && $inputs['nationality'] == 'other') selected @endif>Others</option>
                                </select>
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="col">{{$row->nationality}}</td>
                                ...
                                <td scope="col">{{$row->present_pin}}</td>
                                ...
                                <td scope="col"><a class="btn btn-primary btn-xs" href="{{ asset(url('/guest/detail/'.$row->id)) }}">View</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
...
<script>
    ...
    function getFilter(){
        $('#reportSearch').attr('action',"{{asset(url('guest/report'))}}");
        $('#reportSearch').submit();
    }
    function getExport(){
        $('#reportSearch').attr('action',"{{asset(url('guest/report/export'))}}");
        $('#reportSearch').submit();
    }
