            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select  name="state_id" class="form-select form-select-lg form-control select2" id="state">
                        ...
                        <option value="<?php echo e($cities->id); ?>" <?php if($policestation->city_id == $cities->id): ?> selected <?php endif; ?>><?php echo e($cities->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\sarai_new\resources\views/police_station/edit.blade.php ENDPATH**/ ?>