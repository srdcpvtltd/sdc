...
class LanguageController extends Controller
{
    ...
    public function changeLanquage($lang)
    {
        ...
        return redirect()->back()->with('message', __('Language change successfully.'));
    }
    ...
    public function storeLanguage(Request $request)
    {
        ...
        return redirect()->route('index')->with('message', __('Language successfully created.'));
    }
    ...
    public function destroyLang($lang)
    {
        ...
        if (\Auth::user()->can('delete-langauge')) {
            ...
            return redirect()->route('index')->with('message', __('Language Deleted Successfully.'));
        } else {
            return redirect()->back()->with('error', 'Permission denied.');
        }
    }
